...
- The order is important:
  - =use= statements
  - =implicit none=
  - interface section (it can also be after the variable mixed in with or after
    the variable declarations)
  - Variable declarations
  - Runnable code (all variables need to be declared before any runnable
    code).
  - contains section (has to be at the end because there is no =end contains=)
