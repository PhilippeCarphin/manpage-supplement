...
requires specifying the full directory when activating the environment.  Spack
can also be configured to use a different default directory for environments.
* ADDING PACKAGES
